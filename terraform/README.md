...
# Use Terraform to deploy Happy Shoppy on a GKE cluster

This page walks you through the steps required to deploy the [Happy Shoppy](https://github.com/GoogleCloudPlatform/microservices-demo) sample application on a [Google Kubernetes Engine (GKE)](https://cloud.google.com/kubernetes-engine) cluster using Terraform.
