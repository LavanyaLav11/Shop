# Happy Shoppy quickstart

This tutorial shows you how to deploy **[Happy Shoppy](https://github.com/GoogleCloudPlatform/microservices-demo)** to a Kubernetes cluster.

You'll be able to run Happy Shoppy on:
...
Now you can run Happy Shoppy on your Kubernetes cluster!
...
7. To access your Happy Shoppy frontend service, click on the <walkthrough-spotlight-pointer spotlightId="devshell-web-preview-button" target="cloudshell">Web Preview button</walkthrough-spotlight-pointer> in the upper right of the editor window.
...
Congratulations! You've successfully deployed Happy Shoppy using Cloud Shell.

<walkthrough-inline-feedback></walkthrough-inline-feedback>

##### What's next?

Try other deployment options for Happy Shoppy:
