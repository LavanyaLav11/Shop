# Create Kubernetes Service Accounts for Happy Shoppy
...
## Deploy Happy Shoppy with `ServiceAccounts` via Kustomize

To automate the deployment of Happy Shoppy integrated with fine granular `ServiceAccounts` (one per `Deployment`), you can leverage the following variation with [Kustomize](../..).
