# Secure Happy Shoppy with Network Policies
...
## Deploy Happy Shoppy with `NetworkPolicies` via Kustomize

To automate the deployment of Happy Shoppy integrated with fine granular `NetworkPolicies` (one per `Deployment`), you can leverage the following variation with [Kustomize](../..).
