# Integrate Happy Shoppy with Spanner
...
## Deploy Happy Shoppy connected to a Spanner database

To automate the deployment of Happy Shoppy integrated with Spanner you can leverage the following variation with [Kustomize](../..).
...
- [Use Google Cloud Spanner with the Happy Shoppy sample apps](https://medium.com/google-cloud/f7248e077339)
